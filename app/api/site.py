...
templates.env.globals["GS_HOME_HERO_PRODUCT_IMAGE_URL"] = (os.getenv("GS_HOME_HERO_PRODUCT_IMAGE_URL") or "/static/ui/hero_product.svg").strip()
templates.env.globals["GS_HOME_TEAMS_PRODUCT_IMAGE_URL"] = (os.getenv("GS_HOME_TEAMS_PRODUCT_IMAGE_URL") or "/static/ui/teams_product.svg").strip()
...
templates.env.globals["GS_HOME_NEWS_UI_IMAGE_URL"] = (os.getenv("GS_HOME_NEWS_UI_IMAGE_URL") or "/static/ui/news_ui.svg").strip()
